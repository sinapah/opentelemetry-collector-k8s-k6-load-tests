...
// === TEST CONFIG ===
const TOTAL_ITERATIONS = 300000;
const DURATION_SEC = 600;  // 10 minutes
const RATE = Math.ceil(TOTAL_ITERATIONS / DURATION_SEC);  // This is the number of iterations/sec
const VUS = 10;
...
export function setup() {
  console.log(`Starting load test with ${VUS} VUs at ${RATE} rps for ${DURATION_SEC}s`);
